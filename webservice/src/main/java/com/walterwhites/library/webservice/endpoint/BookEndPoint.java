...
import com.walterwhites.library.consumer.repository.impl.BookRepositoryImplWebservice;
...
public class BookEndPoint {
    ...
    private BookRepositoryImplWebservice bookRepository;

    @Autowired
    public BookEndPoint(BookRepositoryImplWebservice bookRepository) {
